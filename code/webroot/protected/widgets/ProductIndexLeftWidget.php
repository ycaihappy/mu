...
class ProductIndexLeftWidget extends CWidget {
	...
	public function run()
	{
		...
		$entCriteria->with=array('user'=>array('select'=>'user_name,user_first_name,user_mobile_no,user_telephone,user_sex'));
		...
		$data=compact('advEnt');
		$this->render('productIndexLeft',$data);
	}
}
