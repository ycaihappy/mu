...
class ThemeProductWidget extends CWidget
{
	...
	public function run()
    {
        ...
        $this->render('index_product',array('typies'=>$typies,'selectedType'=>$selectedType,'allProvince'=>$allProvince,'recProducts'=>$recProducts, 'data'=>$this->newlist,'proTypes'=>$this->proTypes,'ent'=>$advEnt,'title'=>$category[$_GET['type']]));
	}
}
