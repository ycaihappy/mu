...
<script type="text/javascript" src="http://api.map.baidu.com/api?key=&v=1.1&services=true"></script>	
	 ...
	 <!--百度地图容器-->
  <div style="width:410px;height:400px;border:#ccc solid 1px;" id="dituContent"></div>
</body>
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(112.187618,34.378945);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"安方物流集团",content:"安方物流集团",point:"112.417584|34.804961",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
		 ];
    //创建marker
    function addMarker(){
