...
?>
<div class="m-main-frame" id="J_MainFrame">
	<iframe scrolling="auto" frameborder="no" hidefocus="" id="mainFrame" name="mainFrame" src="<?php echo Yii::app()->controller->createUrl($indexAction)?>"></iframe>
</div>
