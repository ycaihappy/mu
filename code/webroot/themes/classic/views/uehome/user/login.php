		...
		<div class="login-box">
			...
			<?php $form=$this->beginWidget('CActiveForm', array(
				...
				<table>
					...
					<tr>
						<td></td>
                        <td><div class="login-btns"><button tabindex="5" class="btn-login" type="submit">登录</button><a href="<?php echo Yii::app()->controller->createUrl('/uehome/user/register');?>" class="btn-reg">注册</a><br /><a href="#" class="forget">找回密码?</a></div></td>
					</tr>
				</table>
				<?php $this->endWidget(); ?>
			</div>
