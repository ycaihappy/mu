...
<?php echo CHtml::dropDownList('product_status','', $status,array());?>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="table-list" width="100%">
		<tr class="repeatbg">
			<th width="58">状态</th><th width="35">选择</th><th width="300">标题</th><th width="107">品类</th><th width="56">品位</th><th width="106">存货地</th><th width="160">有效期</th><th width="106">操作</th>
		</tr>
