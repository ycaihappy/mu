...
<?php $form = $this->beginWidget('CActiveForm', array(
	...
	<table border="0" cellpadding="0" cellspacing="0" class="table-field">
		...
		<tr>
            <td class="label">名称：</td><td><?php echo $form->textField($model, 'supply_name', array('class'=>'cmp-input'));?><span class="msg">不能包含“.,、/”等特殊字符</span></td>
		</tr>
		<tr>
		...
		<tr>
        <td class="label">电话：</td><td><?php echo $form->textField($model, 'tel', array('class'=>'cmp-input'));?></td>
		</tr>
		<tr>
        <td class="label">价格：</td><td><?php echo $form->textField($model, 'price', array('class'=>'cmp-input'));?></td>
		</tr>
		<tr>
